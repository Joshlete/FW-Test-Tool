...
class RemoteControlPanel:
    def __init__(self, get_ip_func: Callable[[], str], error_label, connect_button, capture_screenshot_button, update_image_callback: Callable[[str], None]):
        ...
        self.password = os.getenv('SSH_PASSWORD', 'myroot')
        self.vnc_port = int(os.getenv('VNC_PORT', '5900'))
        
        # Keep timeout as a constant
        self.timeout = 5
    ...
    def _establish_ssh_connection(self):
        ...
        # Execute remote control panel command from .env
        command = os.getenv('REMOTE_CONTROL_COMMAND')
